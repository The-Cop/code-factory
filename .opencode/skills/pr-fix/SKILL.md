...
user-invocable: true
allowed-tools: Bash(git:*), Bash(gh:*), Bash(jq:*), Bash(bash:*), Bash(make:*), Bash(bzl:*), Bash(env:*), Bash(curl:*), Bash(ddtool:*), Bash(get_ddci_logs.sh:*), Bash(retry_ddci_job.sh:*), Bash(./get-pr-comments.sh:*), Bash(./scripts/*), Read, Write, Edit, Grep, Glob, AskUserQuestion, Task, Skill
---
